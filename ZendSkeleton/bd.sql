...
CREATE TABLE Imovel (id int not null primary key auto_increment, bairro int not null, rua varchar(100) not null, area_total float, area_construida float, valor_iptu decimal(15,2), valor_transacao decimal(15,2), descricao varchar(500),tipo_transacao int not null , proprietario int not null, subCategoria int not null, imovelStatus int not null, FOREIGN KEY(imovelStatus) REFERENCES ImovelStatus(id), FOREIGN KEY(subCategoria) REFERENCES SubCategoriaImovel(id),FOREIGN KEY(proprietario) REFERENCES Proprietario(id) , FOREIGN KEY(tipo_transacao) REFERENCES TipoTransacao(id),FOREIGN KEY(bairro) REFERENCES Bairro(id))
CREATE TABLE ImovelStatus( id int not null primary key auto_increment, anotacoes TEXT, data date, status int not null);
...
CREATE TABLE Imovel (id int not null primary key auto_increment, bairro int not null, rua varchar(100) not null, numero varchar(50), area_total float, area_construida float, valor_iptu decimal(15,2), valor_transacao decimal(15,2), descricao varchar(500),tipo_transacao int not null , proprietario int not null, subCategoria int not null, imovelStatus int not null, FOREIGN KEY(imovelStatus) REFERENCES ImovelStatus(id), FOREIGN KEY(subCategoria) REFERENCES SubCategoriaImovel(id),FOREIGN KEY(proprietario) REFERENCES Proprietario(id) , FOREIGN KEY(tipo_transacao) REFERENCES TipoTransacao(id),FOREIGN KEY(bairro) REFERENCES Bairro(id))
CREATE TABLE ImovelStatus( id int not null primary key auto_increment, anotacoes TEXT, data date, status int not null);
