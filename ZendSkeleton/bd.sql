...
CREATE TABLE Midia (id int not null primary key auto_increment, url varchar(260) not null, posicao int not null, nome varchar(260) not null,tipo int not null, imovel int not null, FOREIGN KEY(imovel) REFERENCES Imovel(id))
